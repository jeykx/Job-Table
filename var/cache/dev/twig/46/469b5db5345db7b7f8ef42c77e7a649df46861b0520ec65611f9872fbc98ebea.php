...
/* job/_form.html.twig */
class __TwigTemplate_bad9869f8e8679787ec0bdbb346337cc4fae6f67e30a4a2f262eb202945c6ddc extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-success mt-5 mb-4\">";
        // line 3
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-success mt-5 mb-4\">{{ button_label|default('Valider') }}</button>
{{ form_end(form) }}
", "job/_form.html.twig", "C:\\project\\www\\JobTable\\templates\\job\\_form.html.twig");
    }
}
